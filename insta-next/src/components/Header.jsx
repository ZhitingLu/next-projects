    ...
    <div className="shadow-sm border-b-gray sticky top-0 bg-white z-30 p-3">
      <div className="flex justify-between items-center max-w-6xl mx-auto">
        ...
        <Link href="/" className="lg:hidden">
          <Image src="/Instagram_icon.png" width={40} height={40} alt="logo" />
        </Link>
        {/* search input */}
        <input
          type="text"
      ...
      </div>
      {
        isOpen && (
          ...
          >
            ...
            />
             <button
                className="w-full bg-red-600 text-white p-2 rounded-lg shadow-md hover:brightness-105 disabled:bg-gray-200 
