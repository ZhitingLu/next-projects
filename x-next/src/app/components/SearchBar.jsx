      ...
      <div className="sticky top-0 bg-white">
        ...
        <input
          ...
          className="border border-gray-200 rounded-3xl bg-white
              text-sm w-full px-4 py-2.5 pl-10 placeholder-gray-700 z-10
        ...
        {focused && query === "" && (
          <div
            className="absolute top-full left-0 w-full bg-white border rounded-xl
             border-gray-100 shadow-lg p-4 translate-y-0.25"
          >
        ...
        {query !== "" && (
            <div
                className="absolute top-full left-0 w-full bg-white border
                 border-gray-100 rounded-xl shadow-lg p-4 translate-y-0.25"
            >
